...
#define WINC1500_INT_SOURCE INT_SOURCE_EXTERNAL_0
#define WINC1500_INT_VECTOR INT_VECTOR_INT0
...
#define WDRV_EXT_RTOS_TASK_SIZE u
#define WDRV_EXT_RTOS_TASK_PRIORITY u

// I/O mappings for general control pins, including CHIP_EN, IRQN, RESET_N and SPI_SSN.
#define WDRV_CHIP_EN_PORT_CHANNEL   PORT_CHANNEL_A
#define WDRV_CHIP_EN_BIT_POS        0

#define WDRV_IRQN_PORT_CHANNEL      PORT_CHANNEL_A
#define WDRV_IRQN_BIT_POS           0

#define WDRV_RESET_N_PORT_CHANNEL   PORT_CHANNEL_A
#define WDRV_RESET_N_BIT_POS        0

#define WDRV_SPI_SSN_PORT_CHANNEL   PORT_CHANNEL_A
#define WDRV_SPI_SSN_BIT_POS        0
